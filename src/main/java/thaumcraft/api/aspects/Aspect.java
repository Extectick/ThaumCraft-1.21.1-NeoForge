...
public enum Aspect {
    ...
    HEAL("sano", 0xff2f34, LIFE, ORDER),
    TRAVEL("iter", 0xe0585b, MOTION, EARTH),
    ELDRITCH("alienis", 0x805080, VOID, DARKNESS),
    MAGIC("praecantatio", 0x9700c0, VOID, ENERGY),
    AURA("auram", 0xffc0ff, MAGIC, AIR),
    TAINT("vitium", 0x800080, MAGIC, ENTROPY),
    SLIME("limus", 0x01f800, LIFE, WATER),
    PLANT("herba", 0x01ac00, LIFE, EARTH),
    TREE("arbor", 0x876531, AIR, PLANT),
    BEAST("bestia", 0x9f6409, MOTION, LIFE),
    FLESH("corpus", 0xee478d, DEATH, BEAST),
    UNDEAD("exanimis", 0x3a4000, MOTION, DEATH),
    MIND("cognitio", 0xffc2b3, FIRE, SOUL),
    SENSES("sensus", 0x0fd9ff, AIR, SOUL),
    MAN("humanus", 0xffd7c0, BEAST, MIND),
    CROP("messis", 0xe1b371, PLANT, MAN),
    MINE("perfodio", 0xdcd2d8, MAN, EARTH),
    TOOL("instrumentum", 0x4040ee, MAN, ORDER),
    HARVEST("meto", 0xeead82, CROP, TOOL),
    WEAPON("telum", 0xc05050, TOOL, FIRE),
    ARMOR("tutamen", 0x00c0c0, TOOL, EARTH),
    HUNGER("fames", 0x9a0305, LIFE, VOID),
